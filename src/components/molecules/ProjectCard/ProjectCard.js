        ...
        <CardContent key={'cardContent'+props.keyIndex}>
            <ListItem key={'li'+props.keyIndex} >
                <Grid item >
                    ...
                    <Typography variant="body2" color="textSecondary">{'$ '+ Math.round(props.cardValue.value.sum)}</Typography>
                    <Typography variant="body2">Meetings Count: </Typography>
                    <Typography variant="body2" color="textSecondary">{props.cardValue.value.count}</Typography>
